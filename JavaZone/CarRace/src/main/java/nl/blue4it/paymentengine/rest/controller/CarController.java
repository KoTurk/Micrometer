...
public class CarController {
    ...
    public String doPitstop() {
        ...
        Timer.builder("car.race.pitstop.meter").register(registry).record(car.refuel());
...
//        return "We did a pitstop in " + car.refuel().toSeconds() + " seconds";
    ...
    public String addLap() {
        // 4.1 Create Counter
        Metrics.counter("car.race.lap").increment();
        return "added a lap";
    }
    ...
    public String tires() {
        ...
        // 5.1 Create Gauge
        Metrics.gauge("car.race.tires", tireWear);
    ...
    public ResponseEntity<Object> crash() {
        ...
        throw new CrashException("Something bad happened");
    }
